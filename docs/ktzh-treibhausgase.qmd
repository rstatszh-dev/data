...
Die Funktion `summarise()` reduziert mehrere Werte auf eine Zusammenfassung.
...
- Die Tastenkombination für den senkrechten Strich \| (OR) in US/CH ist: Shift + / (Windows) und Option + / (Mac)
- Das Tastaturkürzel für den vertikalen Balken \| (OR) in UK: Es ist kompliziert
